...
export const butiks = [
  ...
  },
  {
    ...
    description1:
      '«С годами только лучше»,— так часто говорят про дорогое вино и красивых женщин. То же самое можно сказать про «Золотой Ларец» — сеть ювелирных салонов, которая в этом году празднует 30-летие. Да, да, в это сложно поверить, но первый салон в Краснодаре появился еще в 1994 году, на улице Ставропольской. Многие жители региона не раз бывали там: покупали первые серьги дочерям и племянницам, выбирали свадебные кольца, приводили друзей и коллег, чтобы вместе приобрести презенты. С тех пор изменился и сам город, и «Diamond Couture».',
    description2:
      'За эти годы сеть провела несколько ребрендингов — чтобы оставаться стильной и всегда идти в ногу со временем, открыла несколько новых салонов в разных частях кубанской столицы, усовершенствовала уже существующие. Так, например, этой весной во флагманском салоне на улице Красной, 71/1 открылся третий этаж, где представлены коллекции иностранных и российских топовых брендов: Roberto Bravo, Giovanni Ferraris, Pesavento, Nanis из Италии, Majorica из Испании, Mousson Atelier из Санкт-Петербурга, Art-Couture из Краснодара и, конечно, «Алроса» — ведущей мировой алмазодобывающей компании. Всего же на сегодняшний день «Diamond Couture» сотрудничает более чем с 80 производителями и поставщиками ювелирных украшений, часов, предметов интерьера и роскоши.',
    floor: '1 этаж',
    tel: '+7 989 290 25 04',
    telUrl: '89892902504',
