...
const news = [
  ...
  },
  {
    ...
    title: [
      ...
      <br key={1} />,
      'начнутся 1 июня в 12:00!',
    ],
    text: [
      {
        id: 1,
        t1: 'До лета осталось совсем немного, а значит, время радовать наших маленьких гостей мероприятиями, предназначенными специально для них. Сначала мы отправимся в самую настоящую Италию, где приготовим пиццу по рецепту лучших пиццайло страны — в ресторане Don Bazilio. Когда от пиццы останутся только корочки, мы займемся приготовлением легких коктейлей в Любовь и Трюфель!',
      },
      {
        id: 2,
