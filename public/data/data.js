...
const stilistShowRoom = [
  ...
  {
    id: 6,
    foto: '/showroom_img/s7.jpeg',
    title: 'Рыбалкина Юлия',
    subtitle: 'стилист интерьера',
    text: [
      'Эксперт с многолетним опытом подберет вам текстиль и аксессуары для оформления интерьера вашего дома.',
    ],
    image: [
      {
        id: 1,
        src: '/showroom_img/s7-1.jpeg',
        alt: 'пример 1',
      },
      {
        id: 2,
        src: '/showroom_img/s7-2.jpeg',
        alt: 'пример 2',
      },
      {
        id: 3,
        src: '/showroom_img/s7-3.jpeg',
        alt: 'пример 3',
      },
      {
        id: 4,
        src: '/showroom_img/s7-4.jpeg',
        alt: 'пример 4',
      },
    ],
  },
...
import event31 from '@/public/event_city/ArmenianCulture/1.jpg';

//              Мероприятия
const eventArray = [
  {
    id: id++,
    link: '/event_city/armenian-culture',
    img: event31,
    text: 'Армянская культура',
    target: '',
  },
  {
    id: id++,
