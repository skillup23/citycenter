      ...
      <section className="mt-10">
        <div className="container mx-auto">
          <div className="pr-5 flex flex-row">
            <ul className="flex flex-col pl-3 w-1/3">
              <li className="flex flex-row w-fill items-center">
                <BsFillHexagonFill className="text-3xl mr-5" />
                <h4 className="text-5xl">КИНОТЕАТР</h4>
              </li>
              <li className="flex flex-row w-fill items-center mt-5">
                <BsFillHexagonFill className="text-3xl mr-5 text-[#1e191a]" />
                <h4 className="text-2xl">УЛ. ИНДУСТРИАЛЬНАЯ, 2, ЭТАЖ 2</h4>
              </li>
              <li className="flex flex-row w-fill items-center mt-5">
                <BsFillHexagonFill className="text-3xl mr-5 text-[#1e191a]" />
                <Link href="tel:89676513344" className="text-2xl">
                  +7 967 651 33 44
                </Link>
              </li>
              <li className="flex flex-row w-fill items-center mt-5">
              ...
              <li className="flex flex-row w-fill items-center mt-5">
                <BsFillHexagonFill className="text-3xl mr-5 text-[#1e191a]" />
                <h4 className="text-2xl">ЕЖЕДНЕВНО, 10:00-02:00</h4>
              </li>
            </ul>
            <ul className="flex flex-col pl-3">
              <li className="flex flex-row w-fill items-center">
                <BsFillHexagonFill className="text-3xl mr-5" />
                <h4 className="text-5xl">ОТДЕЛЫ РЕКЛАМЫ</h4>
              </li>
              <li className="flex flex-row w-fill items-center mt-5">
                <BsFillHexagonFill className="text-3xl mr-5 text-[#1e191a]" />
                <h4 className="text-2xl">УЛ. ИНДУСТРИАЛЬНАЯ, 2, ЭТАЖ 2</h4>
              ...
              <li className="flex flex-row w-fill items-center mt-5">
                <BsFillHexagonFill className="text-3xl mr-5 text-[#1e191a]" />
                <Link href="tel:88612134847" className="text-2xl">
                  8 861 213-48-47
                </Link>
              </li>
              <li className="flex flex-row w-fill items-center mt-5">
                <BsFillHexagonFill className="text-3xl mr-5 text-[#1e191a]" />
                <Link href="tel:88612134842" className="text-2xl">
                  8 (861) 213-48-42
                </Link>
              </li>
              <li className="flex flex-row w-fill items-center mt-5">
      ...
      <section className="mt-10">
        <div className="container mx-auto flex gap-6">
          ...
          <div className="flex flex-col gap-6 w-1/3">
            ...
            <h4 className="text-3xl">#WEEKEND С НАДЕЖДОЙ МЕЙХЕР</h4>
            <Link href="https://geo.pro/reportage/523593-fashion-cinema-de-luxe/?sphrase_id=394720">
              <Image
                src={eventText}
                alt="Событие 1"
