        ...
        <div className="lg:container mx-auto">
          ...
          <div className="mt-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 w-full gap-2">
            ...
            >
              ...
              <div className='background_scale duration-300 text-center text-2xl md:text-3xl sm:text-4xl p-6 bg-[url("../public/news/78.jpg")]'></div>
            </Link>
            <Link
              href="/news#new2"
              className="block relative w-full overflow-hidden h-full"
            >
              <Image
                ...
                className=""
              />
              <div className='background_scale bg-center duration-300 text-center text-2xl md:text-3xl sm:text-4xl p-6 bg-[url("../public/services/ChistoBlisto/logo.jpg")]'></div>
            </Link>
            ...
            >
              <Image
                ...
                priority
              />
              <div className='background_scale duration-300 text-center text-2xl md:text-3xl sm:text-4xl p-6 bg-[url("../public/news/76.jpg")]'></div>
            </Link>
            <Link
              href="/news#new4"
              className="block relative w-full overflow-hidden h-full"
            >
              <Image
                ...
                priority
              />
              <div className='background_scale duration-300 text-center text-2xl md:text-3xl sm:text-4xl p-6 bg-[url("../public/news/75.jpg")]'></div>
            </Link>
          </div>
        </div>
      </section>
