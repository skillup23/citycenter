    ...
    <Layout title="Главная">
      ...
      <section className="border_section">
        <div className="container mx-auto pr-5">
          <h2 className="text-9xl title_main text-right mt-12">СЦЕНАРИИ</h2>
          ...
          <p className="w-2/5 text-right ml-auto subtitle_main mt-8">
            ...
            ассортиментом, рестораны итальянской кухни и VIP-кинотеатр.{' '}
            <br></br>В ТРК «СИТИ ЦЕНТР» вы с удовольствием проведёте время в
            комфортной обстановке спокойствия и люксового шоппинга.
          </p>
